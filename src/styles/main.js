/**
 * main.js — Entry point
 * Mengambil semua data dari content.js dan merender ke halaman.
 * JANGAN ubah file ini. Semua perubahan konten ada di: src/data/content.js
 */
